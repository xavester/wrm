...
$ds_prepare_theme_options = array (
	...
	array(
		'name' => 'Currency',
		'desc' => 'What is your currency symbol (see sample <a href="http://www.xe.com/symbols.php" target="_blank">list of symbols here</a>)',
		'id' => $ds_theme_key . 'currency',
		'type' => 'type_currency',
		'default_value' => ''
	),
	array(
		'name' => 'Number of Recent Post in Home Page',
		'desc' => 'How many post that you want to display on the recent posts section in the home page',
	...
	array(
		'name' => 'Blog Setup',
		'desc' => 'Select your blog category on this list to enable the blog functionality of the theme, you can <a href="categories.php">create your category blog here</a>',
	...
	array(
		'name' => 'Exclude Categories in Location Dropdown List',
		'desc' => 'Input category IDs here separated by comma',
		'id' => $ds_theme_key . 'location_exclude_categories',
		'type' => 'type_location_exclude_categories',
		'default_value' => '1'
	),
	array(
   ...
   <div class="wrap">
	...
	foreach ($ds_prepare_theme_options as $value) :
		...
		switch ( $value['type'] ) :		
			...
			case 'type_location_exclude_categories':
				?>
